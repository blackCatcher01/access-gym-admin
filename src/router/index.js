  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { titre: 'Marketplace', icone: 'bi-shop', superAdmin: true },
      },
      {
        path: 'bannieres',
        name: 'bannieres',
        component: () => import('@/views/bannieres/BanneresView.vue'),
        meta: { titre: 'Bannières', icone: 'bi-images', superAdmin: true },
      },
      {
        path: 'etablissement',
        name: 'etablissement',
...
router.beforeEach((to) => {
  ...
  if (to.meta.superAdmin && !auth.estSuperAdmin) {
    return { name: 'tableau-de-bord' };
  }
